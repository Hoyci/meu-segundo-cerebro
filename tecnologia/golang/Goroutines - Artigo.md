...
1. [Introduction](#introduction)  
   ...
   **Paralelismo**: é a capacidade de executar múltiplas tarefas simultaneamente distribuindo-as entre múltiplas entidades capaz de realizar as tarefas, como os núcleos de um processador.
   ...
   Os criadores do Go adotaram a filosofia do *Communicating Sequential Processes* (CSP), na qual você cria sua aplicação utilizando diversas [[goroutines]] que trocam mensagens entre si utilizando canais. Assim, você, como programador, não precisa se preocupar em alocar cada tarefa a um núcleo do processador, basta descrever _o que_ cada parte do programa faz e como elas se comunicam. O runtime do Go cuida de mapear essas goroutines e se o seu computador tiver mais de um núcleo disponível, executa-as em paralelo; se for um processador single‑core, ele faz o revezamento delas de forma rápida (concorrência).
