...
Essa é a explicação mais simples e direta sobre o que é Docker. Eu acho que essa explicação um pouco simplista e pode gerar muitos questionamentos. Irei usar uma analogia para tentar explicar o que é Docker e alguns de seus conceitos.
