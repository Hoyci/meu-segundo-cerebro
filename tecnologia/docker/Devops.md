...
* O que é [[docker networks](https://docs.docker.com/network/)? o que são [[bridges networks]]? o que são [[ host networks]]? o que são [[overlay networks]]? Como criar e gerenciar networks com docker? 
